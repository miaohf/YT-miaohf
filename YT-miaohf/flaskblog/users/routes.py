...
from flaskblog.models import User, Post, Postdtl
...
def register():
    ...
    if form.validate_on_submit():
        ...
        user = User(username=form.username.data, ytuserid=form.ytuserid.data, email=form.email.data, password=hashed_password)
        db.session.add(user)
        db.session.commit()
